...
import 'package:flutterproject/data/database_helper.dart';
...
class Signup_page extends StatefulWidget {
  ...
  const Signup_page({Key key, this.fieldKey, this.hintText, this.labelText, this.helperText, this.onSaved, this.validator, this.onFieldSubmitted}) : super(key: key);
...
class signup extends State<Signup_page> {
